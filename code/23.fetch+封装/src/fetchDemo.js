...
let promise实例(p) = fetch(请求地址,配置项);
    ...
    配置项：
        ...
        + mode 请求模式 [no-cros,*cros,same-origin]
...
*/
//Headers类  new Headers 所有现代浏览器（Chrome/Firefox/Safari/Edge）原生支持！！直接使用，无需导入！！
/* 
