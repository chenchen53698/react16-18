...
/* 
  合成事件：是对浏览器原生事件系统的跨浏览器包装层，提供了统一的事件接口和性能优化。以下是其核心特性和工作原理的深度解析：
   
  绑定的函数基于React内部的处理，如果我们给合成事件绑定一个“普通函数”，当事件行为触发，数执行；方法中的this会是undefined！！ 解决方案：this->实例
...
class Demo extends React.Component {
  // 相当于原型上绑定方法 Demo.prototype => Demo.prototype.handle=function handle(){}
  handle1() {
